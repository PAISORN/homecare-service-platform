...
|---|---|---|---|---|
| IOS-WEB-01 | ลูกค้า | เปิด URL จาก Metro | หน้า Home แสดงครบและเลื่อนได้ ไม่มีหน้าขาว | รอยืนยัน |
| IOS-WEB-02 | ลูกค้า | แตะ “การแจ้งเตือน” | เปิด Notification Center และย้อนกลับได้ | รอยืนยัน |
| IOS-WEB-03 | ลูกค้า | เปิด URL `/notifications?mode=customer` โดยตรง | กดย้อนกลับแล้วกลับ Home โดยไม่มี `GO_BACK` error | รอยืนยัน |
| IOS-WEB-04 | ลูกค้า | เปิดงานที่ยืนยันแล้วและสร้างเคสคุณภาพงาน | เห็นเลขเคส สถานะ ผู้ดำเนินการถัดไป และกำหนด SLA | รอยืนยัน |
| IOS-WEB-05 | ช่าง | เปิด Notification Center หลังลูกค้าสร้างเคส | มีรายการใหม่และ unread badge เพิ่ม | รอยืนยัน |
| IOS-WEB-06 | ช่าง | แตะ notification ของเคส | เปิดเคสของงานเดียวกันและอ่านรายละเอียดได้ | รอยืนยัน |
| IOS-WEB-07 | ช่าง | เพิ่มคำชี้แจง | ลูกค้าได้รับ notification โดยไม่มีที่อยู่หรือเนื้อหาละเอียดบนรายการย่อ | รอยืนยัน |
| IOS-WEB-08 | ลูกค้า | แตะ “อ่านทั้งหมด” | badge หายและทุกรายการเปลี่ยนเป็นอ่านแล้ว | รอยืนยัน |
| IOS-WEB-09 | ผู้ดูแล | เปลี่ยนเคสเป็นรอข้อมูลลูกค้า | ลูกค้าเห็นผู้ดำเนินการถัดไปและกำหนด SLA รอบใหม่ | รอยืนยัน |
| IOS-WEB-10 | ลูกค้า | เพิ่มข้อมูลตามที่ขอ | ช่างได้รับ notification และ timeline เพิ่มแบบ append-only | รอยืนยัน |
| IOS-WEB-11 | ผู้ดูแล | ตัดสินหรือยุติเคส | SLA เป็น “หยุดจับเวลาแล้ว” และทั้งสองฝ่ายเห็นผล | รอยืนยัน |
| IOS-WEB-12 | ทุกบทบาท | เพิ่มขนาดข้อความของ iPhone แล้วทดสอบซ้ำ | ข้อความไม่ทับ ปุ่มยังแตะได้ และไม่มี horizontal scroll | รอยืนยัน |
| IOS-WEB-13 | ทุกบทบาท | หมุนเครื่องเป็น landscape | เนื้อหาอ่านและเลื่อนได้ ปุ่มไม่ถูก browser bar บัง | รอยืนยัน |
...
- `IOS-WEB-01` ถึง `IOS-WEB-13` ไม่มี P0/P1 defect
