...
ไฟล์ `012_service_jobs_and_appointments.test.sql` และ
`013_service_job_operations.test.sql` ทดสอบการเปิดงานจากข้อตกลงที่ยืนยันครบ การตรึงราคา
และนัดหมาย สิทธิ์อ่านของคู่สัญญา ลำดับสถานะปฏิบัติงาน การยกเลิกพร้อมเหตุผล
ประวัติแบบ append-only และการกันข้อมูลข้ามบัญชี
