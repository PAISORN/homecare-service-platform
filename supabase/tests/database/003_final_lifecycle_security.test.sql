...
values
  ('30000000-0000-0000-0000-000000000201', 'ช่างที่ผ่านการตรวจสอบ', '2026-08-31-v1', transaction_timestamp()),
  ('30000000-0000-0000-0000-000000000202', 'ช่างที่ปิดบัญชีก่อนตรวจ', '2026-08-31-v1', transaction_timestamp()),
  ('30000000-0000-0000-0000-000000000204', 'ช่างที่เหลือไฟล์กำพร้า', '2026-08-31-v1', transaction_timestamp());
